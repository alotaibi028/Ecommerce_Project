...
if(!isset($_SESSION['u_id']) || !isset($_SESSION['u_type']) || $_SESSION['u_type'] == 'customer'){
                        ...
                        <li class="menu-item">
                            <div class="dropdown" style="float: none !important;"><a href="#" style="color: #ffffff"><?php echo $lang['view_orders']; ?></a>
                                <div class="dropdown-content" style="min-width: 150px">
                                    <a href="order_history.php"><?php echo $lang['history']; ?></a>
                                    <a href="view_orders.php"><?php echo $lang['current_order']; ?></a>
                                </div>
                            </div>
                        </li>
