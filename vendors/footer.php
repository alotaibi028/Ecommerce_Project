            ...
            <div class="row">
                ...
                <div id="bl2">
                    ...
                    <ul class="menu-footer">
                        <li class="footer-item"><a href="#"><?php echo $lang['about_us']; ?></a></li>
                        <li class="footer-item"><a href="#"><?php echo $lang['terms']; ?></a></li>
                        <li class="footer-item"><a href="#"><?php echo $lang['privacy']; ?></a></li>
                ...
                <div id="bl3">
                    ...
                    <ul class="menu-footer">
                        <li class="footer-item"><a href="#"><?php echo $lang['shipping_policy']; ?></a></li>
                        <li class="footer-item"><a href="#"><?php echo $lang['my_account']; ?></a></li>
                        <li class="footer-item"><a href="#"><?php echo $lang['return_exchange']; ?></a></li>
                        <li class="footer-item"><a href="#"><?php echo $lang['contact_us']; ?></a></li>
                    </ul>
                </div>
                <div id="bl4">
                    <div class="footer-top-title"><h4 class="title-footer"><?php echo $lang['products']; ?></h4></div>
                    <ul class="menu-footer">
                        <li class="footer-item"><a href="#"><?php echo $lang['my_order']; ?></a></li>
