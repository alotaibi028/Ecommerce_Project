<footer class="footer" style="background-color: #ffffff">
            ...
            <div class="row">
                <div id="bl1">
                    ...
                    <div class="footer-infomation">
                        <p><b>Address:</b> Example Street 68, Mahattan,
                            New York, USA</p>
                        <p><b>Phone:</b> + 65 123 456 789</p>
                        <p><b>Email:</b> <a href="#">info@productiveteam.com</a></p>
                    </div>
                </div>
    ...
    <a href="#" class="backtotop ts-block"><span> Top</span></a>
