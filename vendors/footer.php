            ...
            <div class="row">
                ...
                <div id="bl3">
                    ...
                    <ul class="menu-footer">
                        ...
                        <?php }else if(isset($_SESSION['u_id']) && $_SESSION['u_type'] == 'vendor'){ ?>
                            <li class="footer-item"><a href="add_products.php"><?php echo $lang['my_account']; ?></a></li>
                        <?php }else if(isset($_SESSION['u_id']) && $_SESSION['u_type'] == 'admin'){ ?>
                            <li class="footer-item"><a href="../admin/view_users.php">Admin Panel</a></li>
                        <?php } ?>
                ...
                <div id="bl4">
                    ...
                    <ul class="menu-footer">
                        ...
                        <?php }else if(isset($_SESSION['u_id']) && $_SESSION['u_type'] == 'admin'){ ?>
                            <li class="footer-item"><a href="../admin/view_orders.php"><?php echo $lang['my_order']; ?></a></li>
                        <?php } ?>
